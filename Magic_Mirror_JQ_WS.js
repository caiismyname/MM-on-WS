...
function calendarFrontEnd(allDayEvents, timedEvents){
	...
	// an index to the 'weather' element, because it's stored as a list for some reason.
		$("#today-header").append("<br>" + Math.round(weatherForecast.list[0].temp.min), " ", Math.round(weatherForecast.list[0].temp.max), " ", weatherForecast.list[0].weather[0].description, '<br>');
		$("#plusOne-header").append("<br>" + Math.round(weatherForecast.list[1].temp.min), " ", Math.round(weatherForecast.list[1].temp.max), " ", weatherForecast.list[1].weather[0].description,  '<br>');
		$("#plusTwo-header").append("<br>" + Math.round(weatherForecast.list[2].temp.min), " ", Math.round(weatherForecast.list[2].temp.max), " ",weatherForecast.list[2].weather[0].description,  '<br>');
		$("#plusThree-header").append("<br>" + Math.round(weatherForecast.list[3].temp.min), " ", Math.round(weatherForecast.list[3].temp.max), " ",weatherForecast.list[3].weather[0].description, '<br>');
		$("#plusFour-header").append("<br>" + Math.round(weatherForecast.list[4].temp.min), " ", Math.round(weatherForecast.list[4].temp.max), " ",weatherForecast.list[4].weather[0].description, '<br>');
	});
}
